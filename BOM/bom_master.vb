...
'master control to export the document's bill of materials to Epicor ERP
Sub Main()
    ...
    'create missing parameters so we don't crash
    ...
    'try to determine whether the part and material have been exported to Epicor already
    'the flags aren't 100% reliable, since they live in Parameters and can be changed by the user
    Try
    ...
    Catch ex As Exception
        'if the part number was generated by an old version of the species
        ' setup, it may not have the "Exported..." flags
        warn_before_continue = True
